...
public class FD3SInfiniteSummonItem<T extends Entity> extends Item {
    private final RegistryObject<EntityType<T>> carType;

    public FD3SInfiniteSummonItem(RegistryObject<EntityType<T>> carType, Properties properties) {
        super(properties);
